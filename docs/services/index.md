---
title: Kubernetes Service Ports Explained
description: Visual guide to containerPort, targetPort, port, and nodePort — with Mermaid diagrams for ClusterIP, NodePort, LoadBalancer, and DNS flow.
sidebar_position: 4
