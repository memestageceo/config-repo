---
title: Cluster Setup with kubeadm and Flannel
description: Step-by-step guide to bootstrapping a Kubernetes control plane on Ubuntu using kubeadm, containerd, and Flannel CNI — with inline gotcha notes.
sidebar_position: 1
tags: [kubernetes, kubeadm, flannel, containerd, ubuntu]
---
