---
title: DaemonSets
description: DaemonSet behavior, automatic tolerations for unschedulable nodes, and cluster networking context.
sidebar_position: 2
tags: [kubernetes, daemonset, workloads, networking]
---
...
DaemonSets are commonly used to run network plugins (Flannel, Calico, etc.) on every node to solve the pod-to-pod networking problem.
