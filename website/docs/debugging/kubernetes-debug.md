---
title: Kubernetes Debugging Workflow
description: Eight-step debugging checklist — pod status, logs, env vars, service endpoints, secrets, connectivity, and config reload.
sidebar_position: 1
