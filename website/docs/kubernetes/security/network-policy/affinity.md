---
title: Affinity and Node Scheduling
description: Node affinity types, pod affinity/anti-affinity, topology spread constraints, taints, tolerations, and PriorityClasses.
sidebar_position: 2
tags: [kubernetes, affinity, scheduling, taints, tolerations]
---
...
When using preferred affinity type, additional fields are required — especially `weight`.
