---
title: StatefulSets
description: StatefulSet lifecycle, PVC retention policies, headless services, pod identity, rollout strategies, and controller revisions.
sidebar_position: 1
tags: [kubernetes, statefulset, storage, rolling-update]
---
...
- **Graceful Termination:** Scale the sts to 0 before deleting.
...
|----------|-------------|
| `RollingUpdate` | (Default) Implements automated, rolling updates. |
| `OnDelete` | The controller will not automatically update pods. Manual pod deletion is required to trigger a replacement. |
